...
function ProductList({ onHomeClick }) {
    ...
    // Initialize disabled buttons based on cart items
    useEffect(() => {
        const initialDisabled = {};
        cartItems.forEach(item => {
            initialDisabled[item.name] = true;
        });
        setDisabledButtons(initialDisabled);
    }, [cartItems]);
    ...
    const handleAddToCart = (plant) => {
        // Always provide id and quantity for cart logic
        const cartItem = {
            ...plant,
            id: plant.name, // Use name as unique id
            quantity: 1
        };
        dispatch(addItem(cartItem));
        // Disable the button for this plant
        setDisabledButtons({
            ...disabledButtons,
            [plant.name]: true
        });
        ...
        notification.textContent = `${plant.name} added to cart!`;
            ...
            {!showCart ? (
                <div className="product-container">
                    ...
                    <div className="product-grid">
                        {plantsArray[activeCategory].plants.map((plant, index) => (
